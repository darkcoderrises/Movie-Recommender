    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='similar_query', to='booking_system.Movie')),
                ('similar_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='similar_similar_to', to='booking_system.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='StatusType',
